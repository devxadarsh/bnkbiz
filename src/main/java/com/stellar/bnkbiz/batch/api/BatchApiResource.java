 ...
 * under the License.
 */
package com.stellar.bnkbiz.batch.api;
...
import com.stellar.bnkbiz.batch.serialization.BatchRequestJsonHelper;
import com.stellar.bnkbiz.batch.service.BatchApiService;
 ...
 * {@link com.stellar.bnkbiz.batch.service.BatchApiService} and de-serializes the
 * incoming JSON string to a list of
 * {@link com.stellar.bnkbiz.batch.domain .BatchRequest} type. This list is
 * forwarded to BatchApiService which finally returns a list of
 * {@link com.stellar.bnkbiz.batch.domain.BatchResponse} type which is then
 * serialized into JSON response by this Resource class.
 * 
 * @author Rishabh Shukla
 * 
 * @see com.stellar.bnkbiz.batch.service.BatchApiService
