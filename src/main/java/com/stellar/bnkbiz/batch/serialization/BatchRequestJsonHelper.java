 ...
 * under the License.
 */
package com.stellar.bnkbiz.batch.serialization;
...
/**
 * Extends
 * {@link com.stellar.bnkbiz.infrastructure.core.serialization.FromJsonHelper} to
 * de-serialize the incoming String into a JSON List of type
 * {@link com.stellar.bnkbiz.batch.domain.BatchRequest}
 * 
 * @author Rishabh Shukla
 * 
 * @see com.stellar.bnkbiz.batch.domain.BatchRequest
 * @see com.stellar.bnkbiz.infrastructure.core.serialization.FromJsonHelper
 */
@Component
