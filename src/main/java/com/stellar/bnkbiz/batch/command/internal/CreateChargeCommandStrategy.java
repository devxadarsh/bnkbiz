...
/**
 * Implements {@link com.stellar.bnkbiz.batch.command.CommandStrategy} and Create
 * Charge for a Loan. It passes the contents of the body from the BatchRequest
 * to {@link com.stellar.bnkbiz.portfolio.client.api.LoanChargesApiResource} and
 * gets back the response. This class will also catch any errors raised by
 * {@link com.stellar.bnkbiz.portfolio.client.api.LoanChargesApiResource} and map
