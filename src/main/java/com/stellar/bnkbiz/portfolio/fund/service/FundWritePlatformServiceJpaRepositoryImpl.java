 ...
 * under the License.
 */
package com.stellar.bnkbiz.portfolio.fund.service;
...
import com.stellar.bnkbiz.portfolio.fund.serialization.FundCommandFromApiJsonDeserializer;
...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "funds", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
