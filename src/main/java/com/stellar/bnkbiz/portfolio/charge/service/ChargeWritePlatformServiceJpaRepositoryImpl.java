 ...
 * under the License.
 */
package com.stellar.bnkbiz.portfolio.charge.service;
...
import com.stellar.bnkbiz.portfolio.charge.api.ChargesApiConstants;
import com.stellar.bnkbiz.portfolio.charge.domain.Charge;
import com.stellar.bnkbiz.portfolio.charge.domain.ChargeRepository;
import com.stellar.bnkbiz.portfolio.charge.exception.ChargeCannotBeDeletedException;
...
import com.stellar.bnkbiz.portfolio.charge.serialization.ChargeDefinitionCommandFromApiJsonDeserializer;
...
public class ChargeWritePlatformServiceJpaRepositoryImpl implements ChargeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "charges", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
