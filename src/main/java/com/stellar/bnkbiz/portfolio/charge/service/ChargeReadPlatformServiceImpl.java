...
import com.stellar.bnkbiz.portfolio.charge.domain.ChargeAppliesTo;
...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "charges", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
