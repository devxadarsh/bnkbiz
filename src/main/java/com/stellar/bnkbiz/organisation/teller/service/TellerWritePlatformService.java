 ...
 *
 * @author Markus Geiss
 * @see com.stellar.bnkbiz.organisation.teller.domain.TellerRepository
 * @since 2.0.0
 */
public interface TellerWritePlatformService {
     ...
     * @throws com.stellar.bnkbiz.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.stellar.bnkbiz.infrastructure.core.exception.InvalidJsonException
     */
     ...
     * @return {@code CommandProcessingResult} if successful
     * @throws com.stellar.bnkbiz.organisation.teller.exception.TellerNotFoundException
     * @throws com.stellar.bnkbiz.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.stellar.bnkbiz.infrastructure.core.exception.InvalidJsonException
     */
