 ...
 * under the License.
 */
package com.stellar.bnkbiz.organisation.teller.domain;
...
public class Cashier extends AbstractPersistable<Long> {
     ...
     * @see com.stellar.bnkbiz.organisation.office.domain.Office
     */
     ...
     * @see com.stellar.bnkbiz.organisation.staff.domain.Staff
     */
     ...
     * @see com.stellar.bnkbiz.organisation.teller.domain.Teller
     */
