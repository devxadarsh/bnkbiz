...
import com.stellar.bnkbiz.organisation.teller.data.CashierData;
import com.stellar.bnkbiz.organisation.teller.data.CashierTransactionData;
import com.stellar.bnkbiz.organisation.teller.data.CashierTransactionTypeTotalsData;
import com.stellar.bnkbiz.organisation.teller.data.CashierTransactionsWithSummaryData;
import com.stellar.bnkbiz.organisation.teller.data.TellerData;
import com.stellar.bnkbiz.organisation.teller.data.TellerJournalData;
import com.stellar.bnkbiz.organisation.teller.data.TellerTransactionData;
import com.stellar.bnkbiz.organisation.teller.domain.CashierTxnType;
import com.stellar.bnkbiz.organisation.teller.domain.TellerStatus;
...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    @Cacheable(value = "tellers", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
