...
import com.stellar.bnkbiz.infrastructure.codes.data.CodeData;
...
public class CodeReadPlatformServiceImpl implements CodeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "codes", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
