...
public class CodeValueReadPlatformServiceImpl implements CodeValueReadPlatformService {
    ...
    @Override
    @Cacheable(value = "code_values", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#codeId+'cv')")
