...
import com.stellar.bnkbiz.infrastructure.hooks.data.*;
import com.stellar.bnkbiz.infrastructure.hooks.domain.Hook;
import com.stellar.bnkbiz.infrastructure.hooks.domain.HookRepository;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
