 ...
 * under the License.
 */
package com.stellar.bnkbiz.infrastructure.hooks.processor.data;

import static com.stellar.bnkbiz.infrastructure.hooks.api.HookApiConstants.payloadURLName;
import static com.stellar.bnkbiz.infrastructure.hooks.api.HookApiConstants.phoneNumberName;
import static com.stellar.bnkbiz.infrastructure.hooks.api.HookApiConstants.smsProviderAccountIdName;
import static com.stellar.bnkbiz.infrastructure.hooks.api.HookApiConstants.smsProviderName;
import static com.stellar.bnkbiz.infrastructure.hooks.api.HookApiConstants.smsProviderTokenIdName;

import java.util.Set;

import com.stellar.bnkbiz.infrastructure.hooks.domain.HookConfiguration;
