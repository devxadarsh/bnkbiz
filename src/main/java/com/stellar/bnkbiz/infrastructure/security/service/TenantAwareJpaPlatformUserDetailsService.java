 ...
 * under the License.
 */
package com.stellar.bnkbiz.infrastructure.security.service;

import com.stellar.bnkbiz.infrastructure.security.domain.PlatformUser;
import com.stellar.bnkbiz.infrastructure.security.domain.PlatformUserRepository;
...
public class TenantAwareJpaPlatformUserDetailsService implements PlatformUserDetailsService {
    ...
    @Override
    @Cacheable(value = "usersByUsername", key = "T(com.stellar.bnkbiz.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#username+'ubu')")
